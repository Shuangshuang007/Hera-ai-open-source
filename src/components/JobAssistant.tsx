...
export const JobAssistant: React.FC<JobAssistantProps> = ({ onUpdatePreferences, language }) => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 right-4 bg-white rounded-xl shadow-md border border-gray-200 flex flex-col z-50" style={{ width: 660, maxWidth: '90vw', maxHeight: 500, height: 'auto', overflow: 'auto' }}>
